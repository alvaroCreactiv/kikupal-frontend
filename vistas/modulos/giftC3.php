...
<div class="container-fluid fondo">	
	<div class="jumbotron">
		<div class="container">	
			<?php 
			$id=$_GET["id"];
			$recipient=ControladorRecipients::ctrMostrarRecipientOne($id);	
			?>
			<form method="post" onsubmit="return registroContributor()">

				<?php 
				echo '
				<input type="hidden" value="'.$recipient["id_recipient"].'" id="idRec" name="idRec">
				<input type="hidden" value="" id="kiku" name="kiku" readonly>';
				?>
				<div>
					<legend><strong>Contributor</strong></legend>
				</div>
				<div class="contributor">
					...
					<div class="row">
						<div class="col-sm-4 col-sm-offset-4">
							...
							<div class="facebook" id="btnFacebookRegister">
								<p>
					...
					<div class="row">
						<div class="col-sm-3">
							<div class="form-group">
								<input type="text" name="cName" id="cName" placeholder="Firt Name" class="form-control" required>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="form-group">
								<input type="text" name="yEmail" id="yEmail" placeholder="Your Email" class="form-control" required>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								<input type="text" name="pNumber" id="pNumber" placeholder="Phone Number" class="form-control" >
							</div>
						</div>
					</div>	
				</div>	
				<div class="row">
					<div class="col-xs-12 col-sm-12">
						<div class="col-sm-4 col-xs-12">
							<div class="form-group">
								<label >Do you want your gift to be anonymous?</label>
							</div>
						</div>
						<div class="col-sm-8 col-xs-12">
							<div class="form-group opciones">
								<label class="radio-inline">
									<input type="radio" id="yes" name="optanonimous" value="Yes">Yes
								</label>
								<label class="radio-inline">
									<input type="radio" name="optanonimous" value="No" checked>No
								</label>
							</div>
						</div>
					</div>
				...
				<hr>
				<h1><strong> Sending your gift to <?php echo $recipient["bFname"]?></strong></h1>
				<p>Kikupal helps you send need services to your loved ones</p>
				<div class="row">
					<div class="col-lg-3 col-sm-12 col-md-12 col-xs-12">			
						<img id="image_upload_preview" src="
						<?php
						if($recipient["bphoto"]==""){
							echo $url."vistas/img/recipients/default/user.png";
						}else{
							echo $url.$recipient["bphoto"];
						} 
						?>" 
						class="img-responsive img-circle circle" alt="your image"/>	
					</div>
					<div class="col-lg-9 col-sm-12 col-md-12 col-xs-12">			
						<h1><small><?php echo $recipient["bFname"].' '.$recipient["bLname"]?></small></h1>
						<p><?php echo $recipient["bdescription"]?></p>

						<h3>I would like to send <?php  echo $recipient["bFname"]?>:</h3>
							...
							<div class="form-group">
								<ul>
									<li class="col-sm-3 col-xs-12">
										<label class="radio">
											<small>30 kikupoints*</small>
											<input type="radio" name="ship30" id="ship" value="30" class="form-control">
										</label>
									</li>
									<li class="col-sm-3 col-xs-12">
										<label class="radio">
											<small>60 kikupoints*</small>
											<input type="radio" name="ship30" id="ship1" value="60" class="form-control">
										</label>
									</li>
									<li class="col-sm-3 col-xs-12">
										<label class="radio">
											<small>100 kikupoints*</small>
											<input type="radio" checked name="ship30" id="ship2" value="100" class="form-control" >
										</label>
									</li>
									<li class="col-sm-3 col-xs-12">
										<label class="radio">
											<small>Other*</small>							
											<input type="text" id="other" name="ship30" class="form-control 
											input-sm">
										</label>
									</li>
								</ul>
						...
						<p class="text-left">* One kikupoint equals $1 (does not include PayPal's fees)</p>
						<div class="row">
							<div class="col-sm-4">
							...
							<div class="col-sm-8">
								<div class="form-gruoup">
									<textarea class="form-control descripcion" placeholder="Thinking of you. Help is on its way" rows="3" name="note" id="note"></textarea>
								</div>
							</div>
						</div>						
					</div>
				...
				<div class="row foot">
					<div class="col-sm-6 col-xs-12">
						<p><strong>Our promise is to take great care of your loved one!</strong></p>
					</div>
					<div class="col-xs-12 col-sm-6 text-right">		

						<?php 
						$contriRegistro = new ControladorContributor();					
						$contriRegistro -> ctrRegistroContributor();
						?>	

						<button type="submit" name="payment" class="btn btn-primary gift" id_Recip="<?php
						echo $recipient["id_recipient"] ;?>">Send the gift</button>
					</div>
				</div>
			</form>
		</div>
		...
		<div class="modal-content modal-dialog">
			...
			<div class="modal-body modalTitulo">
				...
				<div class="contenido">
					...
					<p>You may only access the Services using authorized means. You will not use the Services for any fraudulent purposes or to cause nuisance, annoyance or inconvenience. It is your responsibility to ensure you have the correct software and equipment for use with the Services. You will only use an access point or data account that you are authorized to use.</p>
					<p>KIKUPAL reserves the right to terminate your use of the Services if you use an incompatible or unauthorized device.</p>

					<p>KIKUPAL’S SERVICES MAY BE SUBJECT TO LIMITATIONS, DELAYS, AND OTHER PROBLEMS INHERENT IN THE USE OF THE INTERNET AND ELECTRONIC COMMUNICATIONS. KIKUPAL IS NOT RESPONSIBLE FOR ANY DELAYS, DELIVERY
					...
					<p>The details you give us are essential for the processing and delivery of your orders, for billing and for the establishment of warranty contracts, therefore failure to provide these details will result in the cancellation of your order. By registering on KIKUPAL, you agree to
					provide us with sincere and true information as it concerns you. </p>
					...
					<p>KIKUPAL alone (and its licensors, where applicable) shall own all of the right, title and interest (including all related intellectual property rights), in and to the past, present, and future versions of the Services and all content therein. This content shall include, but is not
					limited to all layout, text, illustrations, instructions, files, images, designs, software, scripts, graphics, photos, sounds, music, videos, information, materials, technology, interactive features, the “look and feel” of the Services, the compilation and arrangement of the	Services, KIKUPAL trademarks, all copyrightable material (including source code and object code) and derivative works or enhancements of any of the above. Any partial or total reproduction of this content, by any means and on any support, is subject to prior and express authorization by KIKUPAL.</p>
					...
					<p>Any opinions left on the Website by KIKUPAL customers are screened and moderated
						by us. If the comments infringe on the law or are inappropriate (abusive publicity,
					defamation, insults, out of context commentary…), KIKUPAL reserves the right to refuse or modify it.</p>
