<section>
  <div class="container formProvider">
    <h3>New Services Provider</h3>
    <hr>
    <form  method="post" onsubmit="return servicesProvider()">
      <div class="row">
        <div class="col-sm-4 col-sm-offset-4">
          <div class="form-group text-center">
            ...
            <select class="selectpicker form-control show-tick" name="type" id="type">
              <?php 
              $providers= ControladorServices::ctrMostrarTypeService();
      ...
      <?php 
      $regProvider= new ControladorServices();
